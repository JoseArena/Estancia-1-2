        ...
        <table class="title-table">
            <tbody>
                <tr class="table-row">
                    ...
                    <td class="titleBox">
                        <p>Tutoria-Dinamica Grupal <br> {{\Illuminate\Support\Facades\DB::table('carreras')->where('id', $reporte->carrera_id)->value('carrera')}} <br> Reporte de Actividad</p>
                    </td>
    ...
    <div class="center content">
        <table class="content-table" id="datos" style="text-align: center">
            <tbody>
                ...
                <tr>
                    <td>Actividades Realizadas y observaciones</td>
