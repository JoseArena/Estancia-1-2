...
@section('content')
    ...
    <nav class="navbar navbar-light bg-light float-right mt-4">
        <form class="form-inline">
            <h4 class="mr-5">Tutores registrados ({{count(DB::table('tutores')->get())}}) </h4>
    ...
    <nav class="navbar navbar-light bg-light float-right mt-5">
        <form class="form-inline">
            <h4 class="mr-5">Psicólogos registrados ({{count(DB::table('psicologos')->get())}}) </h4>
    ...
    <nav class="navbar navbar-light bg-light float-right mt-5">
        <form class="form-inline">
            <h4 class="mr-5">Alumnos monitores registrados ({{count(DB::table('alumno_monitor')->get())}}) </h4>
